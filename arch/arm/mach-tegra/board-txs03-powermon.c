...
/*
 * arch/arm/mach-tegra/board-txs03-powermon.c
 *
...
static struct i2c_board_info txs03_i2c0_ina219_board_info[] = {
	[INA_I2C_ADDR_40] = {
...
int __init txs03_pmon_init(void)
{
	...
	if (bi.fab == BOARD_FAB_A04) {
		txs03_i2c0_ina219_board_info[INA_I2C_ADDR_44].platform_data =
			&power_mon_info[UNUSED_RAIL];
		txs03_i2c0_ina219_board_info[INA_I2C_ADDR_4A].platform_data =
			&power_mon_info[VDD_CORE_IN];
	}

	i2c_register_board_info(0, txs03_i2c0_ina219_board_info,
		ARRAY_SIZE(txs03_i2c0_ina219_board_info));
	return 0;
}
