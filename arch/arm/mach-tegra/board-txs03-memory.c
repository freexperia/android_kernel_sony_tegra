...
static const struct tegra_emc_table txs03_emc_tables_elpida_1024_00[] =
{
	{
		0x32,       /* Rev 3.2 */
	...
	},
	{
		...
		533000,     /* SDRAM frequency */
		{
			...
			0x00008000, /* EMC_CFG_DIG_DLL_PERIOD */
			0x007f000a, /* EMC_DLL_XFORM_DQS0 */
			0x007f000a, /* EMC_DLL_XFORM_DQS1 */
			0x007f000a, /* EMC_DLL_XFORM_DQS2 */
			0x007f000a, /* EMC_DLL_XFORM_DQS3 */
			0x007f000a, /* EMC_DLL_XFORM_DQS4 */
			0x007f000a, /* EMC_DLL_XFORM_DQS5 */
			0x007f000a, /* EMC_DLL_XFORM_DQS6 */
			0x007f000a, /* EMC_DLL_XFORM_DQS7 */
			0x00000000, /* EMC_DLL_XFORM_QUSE0 */
			0x00000000, /* EMC_DLL_XFORM_QUSE1 */
			0x00000000, /* EMC_DLL_XFORM_QUSE2 */
			0x00000000, /* EMC_DLL_XFORM_QUSE3 */
...
static const struct tegra_emc_table txs03_emc_tables_samsung_1024_00[] =
{
	{
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
	...
	},
	{
		...
		533000,     /* SDRAM frequency */
		{
			...
			0x007f800c, /* EMC_DLL_XFORM_DQS1 */
			0x007f800c, /* EMC_DLL_XFORM_DQS2 */
			0x007f800c, /* EMC_DLL_XFORM_DQS3 */
			0x007f800c, /* EMC_DLL_XFORM_DQS4 */
			0x007f800c, /* EMC_DLL_XFORM_DQS5 */
			0x007f800c, /* EMC_DLL_XFORM_DQS6 */
			0x007f800c, /* EMC_DLL_XFORM_DQS7 */
			0x00000000, /* EMC_DLL_XFORM_QUSE0 */
			0x00000000, /* EMC_DLL_XFORM_QUSE1 */
			0x00000000, /* EMC_DLL_XFORM_QUSE2 */
			0x00000000, /* EMC_DLL_XFORM_QUSE3 */
...
static const struct tegra_emc_table txs03_emc_tables_hynix_1024_00[] =
{
	{
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
...
static const struct tegra_emc_table txs03_emc_tables_elpida_1024_01[] =
{
	{
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
...
static const struct tegra_emc_table txs03_emc_tables_samsung_1024_01[] =
{
	{
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
...
static const struct tegra_emc_table txs03_emc_tables_hynix_1024_01[] =
{
	{
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
...
#define ODMDATA_MEMTYPE_ELPIDA_1024_00   (0x23 << 1)
#define ODMDATA_MEMTYPE_SAMSUNG_1024_00  (0x24 << 1)
#define ODMDATA_MEMTYPE_HYNIX_1024_00    (0x25 << 1)

#define ODMDATA_MEMTYPE_ELPIDA_1024_01   (0x26 << 1)
#define ODMDATA_MEMTYPE_SAMSUNG_1024_01  (0x27 << 1)
#define ODMDATA_MEMTYPE_HYNIX_1024_01    (0x28 << 1)
...
int txs03_emc_init(void)
{
	...
	switch (odmdata_memtype) {
	case ODMDATA_MEMTYPE_ELPIDA_1024_00:
		tegra_init_emc(txs03_emc_tables_elpida_1024_00,
				ARRAY_SIZE(txs03_emc_tables_elpida_1024_00));
		break;
	case ODMDATA_MEMTYPE_ELPIDA_1024_01:
		tegra_init_emc(txs03_emc_tables_elpida_1024_01,
				ARRAY_SIZE(txs03_emc_tables_elpida_1024_01));
		break;
	case ODMDATA_MEMTYPE_SAMSUNG_1024_00:
		tegra_init_emc(txs03_emc_tables_samsung_1024_00,
				ARRAY_SIZE(txs03_emc_tables_samsung_1024_00));
		break;
	case ODMDATA_MEMTYPE_SAMSUNG_1024_01:
		tegra_init_emc(txs03_emc_tables_samsung_1024_01,
				ARRAY_SIZE(txs03_emc_tables_samsung_1024_01));
		break;
	case ODMDATA_MEMTYPE_HYNIX_1024_00:
		tegra_init_emc(txs03_emc_tables_hynix_1024_00,
				ARRAY_SIZE(txs03_emc_tables_hynix_1024_00));
		break;
	case ODMDATA_MEMTYPE_HYNIX_1024_01:
		tegra_init_emc(txs03_emc_tables_hynix_1024_01,
				ARRAY_SIZE(txs03_emc_tables_hynix_1024_01));
		break;
	default:
		/* do nothing */
		break;
