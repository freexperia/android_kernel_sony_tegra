...
#ifdef CONFIG_MACH_TXS03
/* [WAR] Used in hub_port_init */
#define TEGRA_EHCI_TXS03_PHY_FOR_INTERNAL	1
bool tegra_ehci_is_internal_bus(struct usb_bus *bus)
{
	struct tegra_ehci_hcd *tegra = dev_get_drvdata(bus->controller);
	return (TEGRA_EHCI_TXS03_PHY_FOR_INTERNAL == tegra->phy->instance);
}
#endif /* CONFIG_MACH_TXS03 */
